...
&21.21.4, 1.21.5, 1.21.6, 1.21.7, 1.21.8, 1.21.10, 1.21.11

To do so, you can use the `buildAll` task or build specific versions using the custom `buildv_(version)` tasks. For more information, go check the MULTIVERSION.md file on my GitHub.